    ...
    public partial class BetterDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_PhotoGallery_Products_ProductId",
                table: "PhotoGallery");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromWhen = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ToWhen = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsSale = table.Column<bool>(type: "bit", nullable: false),
                    AmountOfItemsAtSale = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfBuilding = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Address_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Address_Orders_OrdersId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopingList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopingList_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_OrdersId",
                table: "Address",
                column: "OrdersId");

            migrationBuilder.CreateIndex(
                name: "IX_Address_OrdersId1",
                table: "Address",
                column: "OrdersId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopingList_UserId",
                table: "ShopingList",
                column: "UserId");

            migrationBuilder.AddForeignKey(
                name: "FK_PhotoGallery_Product_ProductId",
                table: "PhotoGallery",
                column: "ProductId",
                principalTable: "Product",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PhotoGallery_User_UserId",
                table: "PhotoGallery",
                column: "UserId",
                principalTable: "User",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ProductShopingList_Product_ProductsId",
                table: "ProductShopingList",
                column: "ProductsId",
                principalTable: "Product",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ProductShopingList_ShopingList_ShopingListsId",
                table: "ProductShopingList",
                column: "ShopingListsId",
                principalTable: "ShopingList",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
        }
